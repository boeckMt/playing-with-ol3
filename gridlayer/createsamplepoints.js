var checkIfPlaceInCell = function (pointfeature, polyfeature) {
...
var checkIfInPoly = function (point, useExtent) {
...
var createPoints = function (cellsize) {
    var points = [];
    cellsize = cellsize || 1;
    var radius = (cellsize / 2), _x = 180 - radius, _y = 90 - radius;
    for (var x = -_x; x <= _x; x += cellsize) {
        for (var y = -_y; y <= _y; y += cellsize) {
...
var reducePoints = function (points, clipfn) {
    var newPoints = [];
